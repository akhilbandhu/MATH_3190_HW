...
$$L(\lambda|x_1,\ldots,x_{10})=\prod_{i = 1}^{10} \frac{\lambda^{x_i} e^{-\lambda}}{x_i!}.$$ \\
        ...
        Simplifying:
        $$l(\lambda|x_1,\ldots,x_{n})=\prod_{i = 1}^{n} \ln(\frac{\lambda^{x_i} e^{-\lambda}}{x_i!}).$$ 
        
        $$l(\lambda|x_1,\ldots,x_{n})=\prod_{i = 1}^{n} ({x_i}\ln(\lambda) + \ln(e^{-\lambda})-\ln({x_i!})).$$ 
        
        $$l(\lambda|x_1,\ldots,x_{n})=\prod_{i = 1}^{n} ({x_i}\ln(\lambda) - {\lambda}-\ln({x_i!})).$$ 
    ...
    \begin{enumerate}
        ...
        $$\frac{d}{d\lambda}(l(\lambda|x_1,\ldots,x_{n}))=-10+\frac{1}{\lambda}\sum_{i = 1}^{n} {x_i}.$$ 
        
        \item Let's set the derivative to 0 to get the MLE.
        $$-10+\frac{1}{\lambda}\sum_{i = 1}^{n} {x_i} = 0$$ 
    ...
    \begin{enumerate}
        \item Checking if the second derivative is zero everywhere.
...
\begin{enumerate}
    ...
    \item Yes, the MLE is what I thought it would be since the maximum likelihood estimated for $\sigma^2$ is the variance of the measurements
\end{enumerate}
\end{enumerate}
